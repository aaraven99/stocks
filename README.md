...
> Snapshot generation is **real-data only** and will fail if Yahoo data cannot be fetched.
...
- Operational safeguards (market-hours status, stale data alerts, fetch latency, dropped tickers).
